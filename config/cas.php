...
return [
    ...
    */
    'cas_hostname'        => env('CAS_HOSTNAME', 'login.lapan.go.id'),
    ...
    */
    'cas_real_hosts'      => env('CAS_REAL_HOSTS', 'login.lapan.go.id'),
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    'cas_logout_url'      => env('CAS_LOGOUT_URL', 'https://login.lapan.go.id/cas/logout'),
